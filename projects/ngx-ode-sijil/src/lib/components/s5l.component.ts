import { Component, Input, ElementRef, ViewChild, AfterViewInit, ChangeDetectionStrategy, DoCheck } from '@angular/core';
...
export class S5lComponent implements AfterViewInit, DoCheck {
